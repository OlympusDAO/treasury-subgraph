...
> [!WARNING]
> This package is deprecated. New protocol metrics indexing and API work lives in [`OlympusDAO/olympus-protocol-metrics-subgraph`](https://github.com/OlympusDAO/olympus-protocol-metrics-subgraph), with the API hosted at [`treasury-subgraph-api.olympusdao.finance`](https://treasury-subgraph-api.olympusdao.finance).
