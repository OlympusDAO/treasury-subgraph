...
export const getMetricObject = (log: Logger, tokenRecords: TokenRecord[], tokenSupplies: TokenSupply[], protocolMetrics: ProtocolMetric[], options?: { includeRecords?: boolean, dateFallback?: string }): Metric => {
